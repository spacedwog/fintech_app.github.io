...
- O limite diário do plano é checado a cada envio (`Api.getExpenseQuota()`). O plano Free tem 3 despesas/dia — a 4ª em diante abre o modal de pagamento Pix (ver [💳 Plano](#-plano)) antes de salvar.
